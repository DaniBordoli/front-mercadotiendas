...
Last updated: 2025-05-13 Frontend <!-- Mock change for testing -->
...
```
cd existing_repo
git remote add origin https://gitlab.com/mercado.tiendas10-group/mercadotiendas.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/mercado.tiendas10-group/mercadotiendas/-/settings/integrations)
