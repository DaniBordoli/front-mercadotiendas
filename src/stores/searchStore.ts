...
const mockProducts: Product[] = [
   {
    ...
    price: 1599,
    imageUrls: [
      'https://placehold.co/200x200?text=Laptop1_A',
      'https://placehold.co/200x200?text=Laptop1_B',
      'https://placehold.co/200x200?text=Laptop1_C',
      'https://placehold.co/200x200?text=Laptop1_D',
      'https://placehold.co/200x200?text=Laptop1_E',
    ],
    rating: 4.8,
  ...
  },
  {
    ...
    price: 799,
    imageUrls: [
      'https://placehold.co/200x200?text=Laptop2_A',
      'https://placehold.co/200x200?text=Laptop2_B',
      'https://placehold.co/200x200?text=Laptop2_C',
      'https://placehold.co/200x200?text=Laptop2_D',
      'https://placehold.co/200x200?text=Laptop2_E',
    ],
    rating: 4.2,
  ...
  },
  {
  ...
  },
   {
    ...
    price: 450,
    imageUrls: [
      'https://placehold.co/200x200?text=Monitor_A',
      'https://placehold.co/200x200?text=Monitor_B',
      'https://placehold.co/200x200?text=Monitor_C',
      'https://placehold.co/200x200?text=Monitor_D',
      'https://placehold.co/200x200?text=Monitor_E',
    ],
