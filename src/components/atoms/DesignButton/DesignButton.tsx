...
export const DesignButton: React.FC<DesignButtonProps & {
  ...
  const styles = {
    ...getButtonStyles(),
    backgroundColor: customBackgroundColor || getButtonStyles().backgroundColor,
    color: customTextColor || getButtonStyles().color,
    border: customBorderColor ? `2px solid ${customBorderColor}` : getButtonStyles().border,
  };
