...
export const FooterCustom: React.FC<FooterCustomProps> = ({
  backgroundColor = colors.baseBackgroundColor, 
  textColor = colors.baseTextColor, 
  footerSections = [
    {
      title: "Empresa",
      links: [
  ...
  return (
    <footer
      className="footer-container w-full h-[629px] py-8 md:py-12 lg:py-16"
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-row gap-4 md:gap-5 lg:gap-6">
              {socialMediaIcons.map((social, index) => (
                <a key={index} href={social.url} style={{ color: textColor }}> 
                  {social.icon}
                </a>
              ))}
            </div>
      ...
      <div className="container mx-auto mt-20 md:mt-30 lg:mt-40 px-4">
        <div className="flex flex-col">
          <div className="flex justify-between items-end pb-4">
            <p
              className="text-sm w-full md:w-[50%] lg:w-[30%] mt-8 md:mt-10 lg:mt-14 ml-0 md:ml-1 lg:ml-2"
              style={{ color: textColor }} 
            >
              {footerDescription} 
            </p>
          ...
          <div className="text-center text-xs pt-4" style={{ color: textColor }}>
