      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-5 gap-8 mb-12">
          <div className="md:col-span-2">
            <div className="text-2xl font-bold text-white mb-4">Mercado Tiendas</div>
            ...
            <div className="mb-6">
              ...
              <div className="flex">
                <input 
                  ...
                  className="flex-1 px-4 py-3 bg-gray-800 text-white rounded-l-lg border border-gray-700 focus:outline-none focus:border-[#ff4f41]"
                />
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex justify-center">
            <p className="text-gray-400 text-sm">© 2025 Mercado Tiendas. Todos los derechos reservados.</p>
          </div>
        </div>
      </div>
    </footer>
